...
class AdminController extends Controller
{
    ...
    public function dashboard202605(Request $request)
    {
        ...
        return view('admin.dashboard202605', compact(
            'animalStats',
            'recentScans',
            'dailyStats',
            'dailyUniqueUsers',
    ...
    public function dashboard202609(Request $request)
    {
        ...
        return view('admin.dashboard202609', compact(
            'animalStats',
            'recentScans',
            'dailyStats',
            'dailyUniqueUsers',
    ...
    public function dashboard202610(Request $request)
    {
        ...
        return view('admin.dashboard202610', compact(
            'animalStats',
            'recentScans',
            'dailyStats',
            'dailyUniqueUsers',
