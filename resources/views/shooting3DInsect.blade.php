...
<head>
    ...
    <script>  
        ...
        window.enemiesDefeated = 0; // 倒した昆虫の数
        ...
        AFRAME.registerComponent('start-menu', {
            ...
            startGame: function(event) {
                ...
                window.enemiesDefeated = 0; // 倒した昆虫の数をリセット
            ...
            saveScoreToDatabase: function(score) {
                ...
                fetch('api/shooting-scores', {
                    ...
                    body: JSON.stringify({
                        ...
                        enemies_defeated: window.enemiesDefeated || 0, // 倒した昆虫の数
                    })
                })
            ...
            fetchAndDisplayRankings: function() {
                ...
                fetch(`api/shooting-scores/top5?level=${window.currentLevel || 1}&game_mode=insect`)
                    .then(response => response.json())
                    .then(data => {
            ...
            displayRankings: function(rankings) {
                ...
                const levelName = window.currentLevel === 2 ? 'Insect Lv2 Ranking' : 'Insect Lv1 Ranking';
                const levelColor = window.currentLevel === 2 ? '#FF6600' : '#00FF00';
                ...
                rankings.forEach((item, index) => {
                    ...
                    // ランキング行のテキスト（名前の代わりにコンボ数と倒した昆虫数を表示）
                    const rankingText = `${rank}. ${item.score.toFixed(1)}pt  Combo:${item.max_combo || 0}  Insects:${item.enemies_defeated || 0}`;
            ...
            init: function () {
                ...
                this.el.addEventListener('ball-hit', () => {
                    if(!hitFlag) {
                        ...
                        console.log('Insects Defeated:', window.enemiesDefeated);
