...
<body>
    <a-scene 
        ...
        <a-assets timeout="4000">
            <!-- 3Dモデル -->
            <a-asset-item id="model_01" src={{ asset('cg/202606/Model_04.glb') }}></a-asset-item>
            <a-asset-item id="model_02" src={{ asset('cg/202606/Model_08.glb') }}></a-asset-item>
            <a-asset-item id="model_03" src={{ asset('cg/202606/Model_05.glb') }}></a-asset-item>
            <a-asset-item id="model_04" src={{ asset('cg/202606/Model_01.glb') }}></a-asset-item>
            <a-asset-item id="model_05" src={{ asset('cg/202606/Model_02.glb') }}></a-asset-item>
            <a-asset-item id="model_06" src={{ asset('cg/202606/Model_06.glb') }}></a-asset-item>
