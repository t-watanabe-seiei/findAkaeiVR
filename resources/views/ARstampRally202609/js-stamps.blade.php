        // ========== スタンプ定義 ==========
        const STAMPS = {
            'model_01': { name: 'ひつじ', icon: '🐾', model: '202609/Model_01.glb' },
            'model_02': { name: 'いぬ', icon: '🐾', model: '202609/Model_02.glb' },
            'model_03': { name: 'ハムスター', icon: '🐾', model: '202609/Model_03.glb' },
            'model_04': { name: 'コアラ', icon: '🐾', model: '202609/Model_04.glb' },
            'model_05': { name: 'パンダ', icon: '🐾', model: '202609/Model_05.glb' },
            'model_06': { name: 'ぶた', icon: '🐾', model: '202609/Model_06.glb' },
            'model_07': { name: 'ぞう', icon: '🐾', model: '202609/Model_07.glb' },
            'model_08': { name: 'はりねずみ', icon: '🐾', model: '202609/Model_08.glb' },
            'model_09': { name: 'ペンギン', icon: '🐾', model: '202609/Model_09.glb' },
            'model_10': { name: 'ゴリラ', icon: '🐾', model: '202609/Model_10.glb' },
            'model_11': { name: 'ハリセンボン', icon: '🐾', model: '202609/Model_11.glb' },
            'model_12': { name: 'かば', icon: '🐾', model: '202609/Model_12.glb' },
            'model_13': { name: 'カメレオン', icon: '🐾', model: '202609/Model_13.glb' },
            'model_14': { name: 'ウーパールーパー', icon: '🐾', model: '202609/Model_14.glb' },
            'model_15': { name: '白ネコ', icon: '🐾', model: '202609/Model_15.glb' },
            'model_16': { name: 'きじネコ', icon: '🐾', model: '202609/Model_16.glb' },
            'model_17': { name: '白くま', icon: '🐾', model: '202609/Model_17.glb' },
            'model_18': { name: 'カワウソ', icon: '🐾', model: '202609/Model_18.glb' },
            'model_19': { name: 'すずめ', icon: '🐾', model: '202609/Model_19.glb' },
            'model_20': { name: 'キリン', icon: '🐾', model: '202609/Model_20.glb' }
        };
