        // ========== スタンプ定義 ==========
        const STAMPS = {
            'model_01': { name: 'シマウマ', icon: '🐾', model: '202606/Model_01.glb' },
            'model_02': { name: 'シカ', icon: '🐾', model: '202606/Model_02.glb' },
            'model_03': { name: 'とら', icon: '🐾', model: '202606/Model_03.glb' },
            'model_04': { name: 'とり', icon: '🐾', model: '202606/Model_04.glb' },
            'model_05': { name: 'ぶた', icon: '🐾', model: '202606/Model_05.glb' },
            'model_06': { name: 'ビーバー', icon: '🐾', model: '202606/Model_06.glb' },
            'model_07': { name: 'レッサーパンダ', icon: '🐾', model: '202606/Model_07.glb' },
            'model_08': { name: 'きりん', icon: '🐾', model: '202606/Model_08.glb' },
            'model_09': { name: 'いぬ', icon: '🐾', model: '202606/Model_09.glb' },
            'model_10': { name: 'リス', icon: '🐾', model: '202606/Model_10.glb' },
            'model_11': { name: 'あらいぐま', icon: '🐾', model: '202606/Model_11.glb' },
            'model_12': { name: 'チーター', icon: '🐾', model: '202606/Model_12.glb' },
            'model_13': { name: 'きつね', icon: '🐾', model: '202606/Model_13.glb' },
            'model_14': { name: 'パンダ', icon: '🐾', model: '202606/Model_14.glb' },
            'model_15': { name: 'ぞう', icon: '🐾', model: '202606/Model_15.glb' },
            'model_16': { name: 'カタツムリ1', icon: '🐾', model: '202606/Model_16.glb' },
