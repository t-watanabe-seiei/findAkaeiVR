        ...
        const STAMPS = {
            ...
            'model_02': { name: 'キャラクター02', icon: '🐾', model: '202606/Model_02.glb' },
            'model_03': { name: 'キャラクター03', icon: '🐾', model: '202606/Model_03.glb' },
            'model_04': { name: 'キャラクター04', icon: '🐾', model: '202606/Model_04.glb' },
            'model_05': { name: 'キャラクター05', icon: '🐾', model: '202606/Model_05.glb' },
            'model_06': { name: 'キャラクター06', icon: '🐾', model: '202606/Model_06.glb' },
            'model_07': { name: 'キャラクター07', icon: '🐾', model: '202606/Model_07.glb' },
            'model_08': { name: 'キャラクター08', icon: '🐾', model: '202606/Model_08.glb' },
            'model_09': { name: 'キャラクター09', icon: '🐾', model: '202606/Model_09.glb' },
            'model_10': { name: 'キャラクター10', icon: '🐾', model: '202606/Model_10.glb' },
            'model_11': { name: 'キャラクター11', icon: '🐾', model: '202606/Model_11.glb' },
            'model_12': { name: 'キャラクター12', icon: '🐾', model: '202606/Model_12.glb' },
            'model_13': { name: 'キャラクター13', icon: '🐾', model: '202606/Model_13.glb' },
            'model_14': { name: 'キャラクター14', icon: '🐾', model: '202606/Model_14.glb' },
            'model_15': { name: 'キャラクター15', icon: '🐾', model: '202606/Model_15.glb' },
            'model_16': { name: 'キャラクター16', icon: '🐾', model: '202606/Model_16.glb' },
            'model_17': { name: 'キャラクター17', icon: '🐾', model: '202606/Model_17.glb' },
            'model_18': { name: 'キャラクター18', icon: '🐾', model: '202606/Model_18.glb' },
            'model_19': { name: 'キャラクター19', icon: '🐾', model: '202606/Model_19.glb' },
            'model_20': { name: 'キャラクター20', icon: '🐾', model: '202606/Model_20.glb' }
        };

        const TOTAL_STAMP_SLOTS = 20;

        // LocalStorageキー (202606固有)
        ...
        function getCapturedAnimals202606() {
        ...
        function saveCapturedAnimals202606(captured) {
            localStorage.setItem(CAPTURED_KEY, JSON.stringify(captured));
        }

        function markAnimalCaptured(stampId) {
            const captured = getCapturedAnimals202606();
            captured[stampId] = true;
            saveCapturedAnimals202606(captured);
        }
        ...
        var GALLERY_SELECTION_KEY = 'ar-gallery-selection-202606';
        ...
        function getGallerySelection() {
            ...
            if (selection && Array.isArray(selection)) {
                var captured = getCapturedAnimals202606();
