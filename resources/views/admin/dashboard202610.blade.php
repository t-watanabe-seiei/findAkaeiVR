...
<head>
    ...
    <title>管理ダッシュボード202610 - ARスタンプラリー</title>
...
<body>
    <div class="header">
        <h1>📊 ARスタンプラリー202610 管理ダッシュボード（全モデル統計）</h1>
        <div class="nav-links">
    ...
    <div class="prizes-grid">
        ...
        <div class="card">
            ...
            <div style="margin:8px 0 16px; display:flex; gap:8px; align-items:center;">
                <form method="GET" action="{{ route('admin.dashboard202610') }}" style="display:flex; gap:8px; align-items:center;">
                    ...
                    @if(request('q'))
                        <a href="{{ route('admin.dashboard202610') }}" style="padding:6px 10px; background:#e0e0e0; color:#333; border-radius:6px; text-decoration:none;">クリア</a>
                    @endif
                </form>
            </div>
            <table>
