<!-- 20260531 イオンタウン防府カタツムリVR shooting  -->
...
<body>
    <a-scene 
        ...
        <a-assets timeout="4000">
            <!-- 3Dモデル -->
            <a-asset-item id="model_01" src={{ asset('cg/202606/01_snails.glb') }}></a-asset-item>
            <a-asset-item id="model_02" src={{ asset('cg/202606/02_snails.glb') }}></a-asset-item>
            <a-asset-item id="model_03" src={{ asset('cg/202606/03_snails.glb') }}></a-asset-item>
            <a-asset-item id="model_04" src={{ asset('cg/202606/04_snails.glb') }}></a-asset-item>
            <a-asset-item id="model_05" src={{ asset('cg/202606/05_snails.glb') }}></a-asset-item>
            <a-asset-item id="model_06" src={{ asset('cg/202606/06_snails.glb') }}></a-asset-item>
            <a-asset-item id="model_07" src={{ asset('cg/202606/07_snails.glb') }}></a-asset-item>
            <a-asset-item id="model_08" src={{ asset('cg/202606/08_snails.glb') }}></a-asset-item>

            <!-- サウンド -->
            <audio id="sound_hit" src={{ asset('cg/sound_hit01.mp3') }} preload="auto"></audio>
            <audio id="sound_bgm" src={{ asset('cg/sound_bgm12.mp3') }} preload="auto"></audio>
